...
namespace Core.Resources {
  public class MappingProfile : Profile {
    public MappingProfile() {
      ...
      CreateMap<IdentityUser, AuthorResource>().ForMember(
          ar => ar.Name, opt => opt.MapFrom(u => u.UserName));
      ...
      CreateMap<ArticleResource, Article>().ForMember(
          a => a.AuthorId, opt => opt.MapFrom(ar => ar.Author.Id));
    }
  }
}
